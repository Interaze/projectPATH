<?php
    ...
    if(!$subFirstName || !$subLastName || !$subUserName || !$subEmail || !$subPassword){
        ...
        if (($rows = $conn->query($sql)) !== FALSE) {
            $sql = "INSERT INTO `Users` (`PK`, `UserName`, `Email`, `FirstName`, `LastName`, `Password`, `Folder`, `isAdmin`) VALUES (NULL, '".$subUserName."', '".$subEmail."', '".$subFirstName."', '".$subLastName."', '".$subPassword."', '../Folders/".$subUserName."', '0');";
                ...
                if (($conn->query($sql)) !== FALSE) {
                    ...
                    $_SESSION['Folder'] = '../Folders/".$subUserName."';
                    $_SESSION['isAdmin'] = 0;
                    ...
                    echo json_encode([
                        'msg' => 'Sorry, We weren\'t able to create an account right now',
                        'Error' => '1'
                    ]);
                }
        }
