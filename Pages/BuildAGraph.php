    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="logIn">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-footer d-block w-100">
                <button type="button" class="btn btn-danger float-left" onclick="showSignUp()">Sign Up</button>
                <button type="button" class="btn btn-secondary float-right" data-dismiss="modal">Cancel</button>
                <button type="submit" class="btn btn-primary float-right" data-dismiss="modal">Sign In</button>
            </div>
            </form>
            </div>
        </div>
